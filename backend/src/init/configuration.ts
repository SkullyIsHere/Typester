...
function mergeConfigurations(
  baseConfiguration: Typester.Configuration,
  liveConfiguration: Partial<Typester.Configuration>
): void {
  if (
...
): Promise<Typester.Configuration> {
  if (
    attemptCacheUpdate &&
...
export async function getLiveConfiguration(): Promise<Typester.Configuration> {
...
async function pushConfiguration(
  configuration: Typester.Configuration
): Promise<void> {
...
export async function patchConfiguration(
  configurationUpdates: Partial<Typester.Configuration>
): Promise<boolean> {
  try {
